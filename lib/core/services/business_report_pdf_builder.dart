    ...
    pdf.addPage(
      pw.MultiPage(
        ...
        build: (ctx) => [
          ...
          pw.SizedBox(height: 16),
          _section('Customer Verification'),
          _row('Verified', '${report.verifiedCustomers}'),
          _row('Needs Reconciliation', '${report.customersNeedingReconciliation}'),
          _row('Not Verified', '${report.notVerifiedCustomers}'),
          pw.SizedBox(height: 16),
          _section('Deliveries'),
          ...
          _row('Supply Purchases', '${report.periodSupplierDeliveries}'),
          ...
          _row('Business Bottle Sales', '${report.walkInBusinessBottleSalesCount}'),
          _row('Customer Bottle Refills', '${report.walkInCustomerRefillsCount}'),
