    ...
    pdf.addPage(
      pw.MultiPage(
        ...
        build: (ctx) => [
          ...
          _row('Owner Capital', CurrencyFormatter.format(report.totalOwnerCapital)),
          _row('Accumulated Profit', CurrencyFormatter.format(report.accumulatedProfit)),
          _row('Savings Account', CurrencyFormatter.format(report.savingsAccountBalance)),
          _row('Business Cash', CurrencyFormatter.format(report.businessCash)),
          _row('Cash Available', CurrencyFormatter.format(report.cashAvailable)),
